...
|----------|----------|------|
| **Windows (Installer)** | [Download Setup.exe](https://github.com/singaxdev/markdown-editor-pro/releases/v1.0.0/Markdown-Editor-Pro-Setup-1.0.0.exe) | 183MB |
...
| **macOS (Apple Silicon)** | [Download .dmg](https://github.com/singaxdev/markdown-editor-pro/releases/v1.0.0/Markdown-Editor-Pro-1.0.0-arm64.dmg) | 110MB |
| **Linux (AppImage)** | [Download .AppImage](https://github.com/singaxdev/markdown-editor-pro/releases/v1.0.0/Markdown-Editor-Pro-1.0.0.AppImage) | 121MB |
